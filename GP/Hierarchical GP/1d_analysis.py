...
plt.contourf(Theta0, Theta1, -LML,
            levels=level, norm=LogNorm(vmin=vmin, vmax=vmax), alpha=1, extend='both')
plt.xscale("log")
plt.yscale("log")
...
plt.xlabel("Length-scale", fontsize='small')
plt.ylabel("Noise-level", fontsize='small')
plt.xticks(fontsize='small')
plt.yticks(fontsize='small')
plt.title("Negative Log-marginal-likelihood", fontsize='small')
