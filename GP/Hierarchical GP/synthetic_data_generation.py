...
def plot_datasets(data_sets, snr, unif, ylim):
...
if __name__ == "__main__":
    ...
    plot_datasets(data_sets, snr, 'Unif', 8)
    ...
    for i in seq_n_train:
          ...
          path = '/home/vidhi/Desktop/Workspace/CoreML/GP/pymc3/Data/1d/' + struct_tag + '/' + snr_tag +'/'
          persist_datasets(X, y, X_star, f_star, path, suffix)

    # Persist the f_all and X_all

    path = '/home/vidhi/Desktop/Workspace/CoreML/GP/pymc3/Data/1d/'
